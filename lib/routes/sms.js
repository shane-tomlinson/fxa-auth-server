  ...
  return [
    {
      ...
      config: {
        ...
        validate: {
          payload: {
            ...
            signinCodeData: isA.string().optional()
          }
        }
      },
      handler (request, reply) {
        ...
        let phoneNumberUtil, parsedPhoneNumber, signinCode
        ...
        function createSigninCode () {
          if (request.app.features.has('signinCodes')) {
            return request.gatherMetricsContext({})
              .then(metricsContext => db.createSigninCode(sessionToken.uid, metricsContext.flow_id, request.payload.signinCodeData))
          }
        }

        function sendMessage (_signinCode) {
          signinCode = _signinCode
        ...
        function createResponse () {
          return {
            ...
            signinCode: urlSafeBase64(signinCode)
          }
        }
